...
from vla_arena.models.openvla_oft.prismatic.extern.hf.modeling_prismatic import OpenVLAForActionPrediction
from vla_arena.models.openvla_oft.prismatic.extern.hf.processing_prismatic import PrismaticImageProcessor, PrismaticProcessor
from vla_arena.models.openvla_oft.prismatic.models.action_heads import DiffusionActionHead, L1RegressionActionHead
from vla_arena.models.openvla_oft.prismatic.models.film_vit_wrapper import FiLMedPrismaticVisionBackbone
from vla_arena.models.openvla_oft.prismatic.models.projectors import NoisyActionProjector, ProprioProjector
from vla_arena.models.openvla_oft.prismatic.vla.constants import (
    ACTION_DIM,
    ACTION_PROPRIO_NORMALIZATION_TYPE,
)
from vla_arena.models.openvla_oft.prismatic.vla.datasets.rlds.utils.data_utils import NormalizationType
...
def update_auto_map(pretrained_checkpoint: str) -> None:
    ...
    print("Changes made:")
    print('  - Set AutoConfig to "configuration_vla_arena.models.openvla_oft.prismatic.OpenVLAConfig"')
    print('  - Set AutoModelForVision2Seq to "modeling_vla_arena.models.openvla_oft.prismatic.OpenVLAForActionPrediction"')
...
def check_model_logic_mismatch(pretrained_checkpoint: str) -> None:
    ...
    # Find current files
    curr_files = {"modeling_vla_arena.models.openvla_oft.prismatic.py": None, "configuration_vla_arena.models.openvla_oft.prismatic.py": None}
