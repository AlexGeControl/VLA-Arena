...
def homunculus_glove_to_hope_jr_hand(glove_action: dict[str, float]) -> dict[str, float]:
    return {
        ...
        'index_radial_flexor.pos': get_radial_flexion(
            glove_action['index_mcp_flexion.pos'],
            glove_action['index_mcp_abduction.pos'],
            INDEX_SPLAY,
        ),
        ...
        'middle_radial_flexor.pos': get_radial_flexion(
            glove_action['middle_mcp_flexion.pos'],
            glove_action['middle_mcp_abduction.pos'],
            MIDDLE_SPLAY,
        ),
        ...
        'pinky_radial_flexor.pos': get_radial_flexion(
            glove_action['pinky_mcp_flexion.pos'],
            glove_action['pinky_mcp_abduction.pos'],
            PINKY_SPLAY,
        ),
