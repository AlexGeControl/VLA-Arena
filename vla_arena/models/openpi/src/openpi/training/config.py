...
_CONFIGS = [
    ...
    TrainConfig(
        ...
        weight_loader=weight_loaders.CheckpointWeightLoader(
            os.getenv("OPENPI_VLA_ARENA_CHECKPOINT_PATH", "gs://openpi-assets/checkpoints/pi0_base/params")
        ),
        num_train_steps=30_000,
    ),
    TrainConfig(
    ...
    TrainConfig(
        ...
        weight_loader=weight_loaders.CheckpointWeightLoader(
            os.getenv("OPENPI_VLA_ARENA_CHECKPOINT_PATH", "/path/to/your/openpi/pi0-vla-arena/params")
        ),
        num_train_steps=30_000,
        freeze_filter=pi0_config.Pi0Config(
            paligemma_variant="gemma_2b_lora", action_expert_variant="gemma_300m_lora"
