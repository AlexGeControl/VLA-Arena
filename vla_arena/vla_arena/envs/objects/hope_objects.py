...
class HammerHandle(HopeBaseObject):
    def __init__(self, name="hammer_handle", obj_name="hammer_handle", duplicate_collision_geoms=True):
...
class RotatedScissorsPi(HopeBaseObject):
    def __init__(self, name="rotated_scissors_pi", obj_name="scissors", duplicate_collision_geoms=True):
        super().__init__(name, obj_name, duplicate_collision_geoms)
        self.rotation = (np.pi/2, np.pi/2)
        self.rotation_axis = "x"
...
class RotatedScissors(HopeBaseObject):
    def __init__(self, name="rotated_scissors", obj_name="scissors", duplicate_collision_geoms=True):
        super().__init__(name, obj_name, duplicate_collision_geoms)
