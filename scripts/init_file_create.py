...
parser.add_argument("--output_path", type=str, default="./vla_arena/vla_arena/init_files", help="Output path")
parser.add_argument("--root_path", type=str, default="./vla_arena/vla_arena/bddl_files", help="Root path")
...
def process_single_file(bddl_file, relative_path=""):
    ...
    env_args = {"bddl_file_name": bddl_file, "camera_heights": resolution, "camera_widths": resolution}
    env = None
